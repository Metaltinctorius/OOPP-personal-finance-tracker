...
/**
 * Represents a record in a portfolio, tracking a specific sector and the associated quantity. The
 * quantity starts at 0 and can be updated with new additions.
 */
public class PortfolioRecord {
  ...
  /**
   * Constructs a PortfolioRecord with a specified sector. The quantity is initialized to 0.
   *
